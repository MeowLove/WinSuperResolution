    ...
    internal static class Strings
    {
        ...
        private static IDictionary<string, string> CreateEnglish()
        {
            return Create(
                ...
                "CurrentState", "Current Windows mode and scale", "AvailableModes", "Windows-supported modes", "ApplyMode", "Test & apply current mode", "ExperimentalScale", "Experimental per-monitor scale", "ApplyScale", "Apply experimental scale", "ModeNoSelection", "Select a display record to inspect current Windows modes.", "ModeRequiresActive", "Current-mode changes require an Active display record.", "ModeRequiresExact", "Current-mode changes are disabled because this display association is Candidate, not Exact.", "ModeNoLiveDisplay", "The active display has no live Windows display object.", "ModeNoModes", "No Windows-supported display modes are available for this record.", "ModeAvailable", "This Active + Exact display association can test and apply a Windows-supported mode.",
        ...
        private static IDictionary<string, string> CreateChinese()
        {
            return Create(
                ...
                "CurrentState", "当前 Windows 分辨率与缩放", "AvailableModes", "Windows 当前支持的模式", "ApplyMode", "测试并应用当前分辨率", "ExperimentalScale", "实验性每显示器缩放", "ApplyScale", "应用实验性缩放", "ModeNoSelection", "请选择显示配置以检查当前 Windows 分辨率。", "ModeRequiresActive", "直接切换当前分辨率需要选择活动显示配置。", "ModeRequiresExact", "当前分辨率操作已禁用：此显示器关联为“候选”，尚未达到“精确（Exact）”。", "ModeNoLiveDisplay", "该活动显示器没有可用的实时 Windows 显示对象。", "ModeNoModes", "此记录没有可供 Windows 直接切换的显示模式。", "ModeAvailable", "此 Active + Exact 显示器关联可测试并应用 Windows 当前支持的模式。",
        ...
        private static IDictionary<string, string> CreateRussian()
        {
            return Create(
                ...
                "CurrentState", "Текущий режим Windows и масштаб", "AvailableModes", "Режимы, доступные в Windows", "ApplyMode", "Проверить и применить режим", "ExperimentalScale", "Экспериментальный масштаб для монитора", "ApplyScale", "Применить экспериментальный масштаб", "ModeNoSelection", "Выберите конфигурацию дисплея для проверки текущих режимов Windows.", "ModeRequiresActive", "Для изменения текущего режима требуется активная конфигурация дисплея.", "ModeRequiresExact", "Изменение текущего режима отключено: связь дисплея Candidate, а не Exact.", "ModeNoLiveDisplay", "Для активного дисплея нет доступного объекта Windows в реальном времени.", "ModeNoModes", "Для этой записи нет режимов Windows, доступных для переключения.", "ModeAvailable", "Эта связь Active + Exact может проверить и применить режим, доступный в Windows.",
