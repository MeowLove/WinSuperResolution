    ...
    internal static class Strings
    {
        ...
        private static IDictionary<string, string> CreateEnglish()
        {
            return Create(
                ...
                "CurrentState", "Current Windows mode and scale", "AvailableModes", "Windows-supported modes", "ApplyMode", "Test & apply current mode", "ExperimentalScale", "Experimental per-monitor scale",
        ...
        private static IDictionary<string, string> CreateChinese()
        {
            return Create(
                ...
                "CurrentState", "当前 Windows 分辨率与缩放", "AvailableModes", "Windows 当前支持的模式", "ApplyMode", "测试并应用当前分辨率", "ExperimentalScale", "实验性每显示器缩放",
        ...
        private static IDictionary<string, string> CreateRussian()
        {
            return Create(
                ...
                "CurrentState", "Текущий режим Windows и масштаб", "AvailableModes", "Режимы, доступные в Windows", "ApplyMode", "Проверить и применить режим", "ExperimentalScale", "Экспериментальный масштаб для монитора",
