...
namespace WinSuperResolution.Resources
{
    ...
    internal static class Strings
    {
        ...
        private static IDictionary<string, IDictionary<string, string>> CreateValues()
        {
            ...
            AddCompatibilityDetailStrings(chinese, "所选显示器", "适配器关联", "驱动新鲜度", "其它显示适配器", "请选择活动显示器。", "与 Windows 当前显示适配器名称精确匹配。", "Windows 已报告当前显示适配器，但无法在 WMI 驱动清单中精确匹配。", "无法取得驱动日期。", "距驱动日期：{0} 天；提示上限：{1} 天。", "未检测到其它显示适配器。");
            ...
            AddCompatibilityDetailStrings(russian, "Выбранный дисплей", "Связь с адаптером", "Свежесть драйвера", "Другие адаптеры дисплея", "Выберите активный дисплей.", "Точное совпадение имени с активным адаптером дисплея Windows.", "Windows сообщает об активном адаптере, но его запись драйвера WMI не удалось сопоставить.", "Дата драйвера недоступна.", "Возраст: {0} дн.; рекомендательный предел: {1} дн.", "Другие адаптеры дисплея не обнаружены.");
